...
map.getView().fit([12883869.731573, -3772136.110738, 12885313.065443, -3770805.561200], map.getSize());
...
var onSingleClick = function(evt) {
    ...
    for (i = 0; i < wms_layers.length; i++) {
        if (wms_layers[i][1]) {
            ...
            if (url) {
                popupText = popupText + '<iframe style="width:100%;height:50px;border:0px;" id="iframe" seamless src="' + url + '"></iframe>';
            }
        }
    }
